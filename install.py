...
if sys.platform == "win32":
    os.system("pip install requests requests[socks] colorama psutil fake-useragent")
    os.system('cls')
    os.system("python sigmaproxy_win.py")
if sys.platform == "linux":
    os.system("sudo apt install python3-full")
    os.system("pip3 install requests requests[socks] colorama psutil fake-useragent")
    os.system('clear')
